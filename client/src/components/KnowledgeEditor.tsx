...
export function KnowledgeEditor({
  ...
  const [formData, setFormData] = useState({
    ...
    // 多维度内容
    positiveEvidence: initialData?.positiveEvidence
      ? JSON.stringify(JSON.parse(initialData.positiveEvidence), null, 2)
      : "",
    negativeEvidence: initialData?.negativeEvidence
      ? JSON.stringify(JSON.parse(initialData.negativeEvidence), null, 2)
      : "",
    neutralAnalysis: initialData?.neutralAnalysis || "",
    practicalGuide: initialData?.practicalGuide
      ? JSON.stringify(JSON.parse(initialData.practicalGuide), null, 2)
      : "",
    caseStudies: initialData?.caseStudies
      ? JSON.stringify(JSON.parse(initialData.caseStudies), null, 2)
      : "",
    expertOpinions: initialData?.expertOpinions
      ? JSON.stringify(JSON.parse(initialData.expertOpinions), null, 2)
      : "",
    ...
    sources: initialData?.sources
      ? JSON.stringify(JSON.parse(initialData.sources), null, 2)
      : "",
        ...
        <div>
          ...
          <Input
            ...
            onChange={e =>
              setFormData({
                ...formData,
                credibility: parseInt(e.target.value) || 5,
              })
            }
          />
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <Button
              type="button"
              onClick={() => addMedia("images", newImageUrl)}
            >
        ...
        <div>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <Button
              type="button"
              onClick={() => addMedia("videos", newVideoUrl)}
            >
              <Plus className="w-4 h-4" />
            </Button>
          </div>
        ...
        <div>
          ...
          <div className="flex gap-2 mt-2">
            ...
            <Button
              type="button"
              onClick={() => addMedia("audio", newAudioUrl)}
            >
              <Plus className="w-4 h-4" />
            </Button>
          </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <Textarea
            ...
            onChange={e =>
              setFormData({ ...formData, positiveEvidence: e.target.value })
            }
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={e =>
              setFormData({ ...formData, negativeEvidence: e.target.value })
            }
            placeholder='[{"source": "来源", "content": "内容", "data": "数据"}]'
            rows={4}
          />
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={e =>
              setFormData({ ...formData, neutralAnalysis: e.target.value })
            }
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={e =>
              setFormData({ ...formData, practicalGuide: e.target.value })
            }
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={e =>
              setFormData({ ...formData, caseStudies: e.target.value })
            }
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={e =>
              setFormData({ ...formData, expertOpinions: e.target.value })
            }
