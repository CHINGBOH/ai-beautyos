...
const AppointmentChatBot = lazy(() =>
  import("./AppointmentChatBot").then(module => ({
...
export function ServiceDetailModal({
  ...
  type ServiceDetail = Awaited<ReturnType<typeof landingApi.getServiceDetail>>;
  ...
  if (!serviceId && !chatOpen) return null;
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="sticky top-0 bg-white border-b border-stone-100 px-6 py-4 flex items-center justify-between z-10">
                    <div>
                      <h2 className="text-2xl font-light tracking-tight text-stone-900 font-serif">
                        {service.name}
                      </h2>
                      {service.fullName && (
                  ...
                  <div className="p-6 space-y-8">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-sm font-medium ${getPainLevelColor(service.painLevel)}`}
                        >
                          {service.painLevel}/10{" "}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {service.indications.map((item: string) => (
                          <span
                            key={item}
                            className="px-3 py-1 bg-stone-50 text-stone-600 text-sm rounded-full"
                          >
                            {item}
                          </span>
                        ))}
